...
export default {
  ...
  methods:{
    ...
    submitElement(){
      store.dispatch('incrementPush',{gender: this.gender})
      router.beforeEach(()=>{
        if(this.gender === ""){
          return false;
        }
  ...
  <main class="gender">
    <div class="containerMain">
      <div class="containerMain-items">
        ...
        <p class="text">Ваш пол:</p>
        <div class="contaner-item" v-on:click="activeElement" >
          <div class="contaner-item__active" ></div>
          <p class="contaner-item__text" >мужчина</p>
        </div>
        <div class="contaner-item" v-on:click="activeElement" >
          <div class="contaner-item__active"></div>
          <p class="contaner-item__text">женщина</p>
        </div>
        <RouterLink  class="containerMain-items__buttom" v-on:click="submitElement" to="/gender/birthYear">далее</RouterLink>
      </div>
    </div>
  </main>
</template>

...
export default {
  ...
  methods:{
    ...
    this.birth_year=e.target.innerText;
    ...
    submitElement(){
      store.dispatch('incrementPush',{birth_year: this.birth_year})
      router.beforeEach(()=>{
        if(this.birth_year === ""){
          return false;
        }
  ...
  <main class="about">
    <div class="containerMain">
      <div class="containerMain-items">
        ...
        <p class="text">Укажите ваш возраст:</p>
        <div class="contaner-item" v-on:click="activeElement" >
          <div class="contaner-item__active" ></div>
          <p class="contaner-item__text" >До 18</p>
        </div>
        <div class="contaner-item" v-on:click="activeElement" >
          <div class="contaner-item__active"></div>
          <p class="contaner-item__text">От 18 до 28</p>
        </div>
        <div class="contaner-item" v-on:click="activeElement" >
          <div class="contaner-item__active"></div>
          <p class="contaner-item__text">От 29 до 35</p>
        </div>
        <div class="contaner-item" v-on:click="activeElement" >
          <div class="contaner-item__active"></div>
          <p class="contaner-item__text">От 36</p>
        </div>
        <RouterLink class="containerMain-items__buttom" v-on:click="submitElement" to="/gender/birthYear/excess">далее</RouterLink>
      </div>
    </div>
  </main>
</template>

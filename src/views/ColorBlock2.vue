...
export default {
  ...
  data () {
    ...
    width: '105px',
    isActive: true, 
    massElem: ['gray','teal','brown','green','black','red','purple','yellow','blue'],
    colorBlock2: "",
    }
  },
  methods:{
    ...
    this.colorBlock2=e.target.style.backgroundColor;
      e.currentTarget.classList.add("activeBorder");
     
    this.width = '126px';
    },
    submitElement(){
      store.dispatch('incrementPush',{colorBlock2: this.colorBlock2})
      router.beforeEach(()=>{
        if(this.colorBlock2 === ""){
          return false;
        }
  ...
  <main class="about">
    <div class="containerMain">
      <div class="containerMain-items">
        ...
        <p class="text">Отдохните пару секунд, еще раз Выберите цвет, который сейчас наиболее Вам приятен:</p>
        ...
        <RouterLink class="containerMain-items__buttom" v-on:click="submitElement" to="/gender/birthYear/excess/number/colorBlock/colorBlock2/city">далее</RouterLink>
      </div>
    </div>
  </main>
</template>

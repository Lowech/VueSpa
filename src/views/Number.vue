...
export default {
  ...
  methods:{
    ...
    submitElement(){
      store.dispatch('incrementPush',{num: this.num})
      router.beforeEach(()=>{
        if(this.num === ""){
          return false;
        }
  ...
  <main class="about">
    <div class="containerMain">
      <div class="containerMain-items">
        ...
        <p class="text">Продолжите числовой ряд: <br> 18  20  24  32</p>
        <div class="contaner-item" v-on:click="activeElement" >
          <div class="contaner-item__active" ></div>
          <p class="contaner-item__text" >62</p>
        </div>
        <div class="contaner-item" v-on:click="activeElement" >
          <div class="contaner-item__active"></div>
          <p class="contaner-item__text">48</p>
        </div>
        <div class="contaner-item" v-on:click="activeElement" >
          <div class="contaner-item__active"></div>
          <p class="contaner-item__text">74</p>
        </div>
        <div class="contaner-item" v-on:click="activeElement" >
          <div class="contaner-item__active"></div>
          <p class="contaner-item__text">57</p>
        </div>
        <div class="contaner-item" v-on:click="activeElement" >
          <div class="contaner-item__active"></div>
          <p class="contaner-item__text">60</p>
        </div>
        <div class="contaner-item" v-on:click="activeElement" >
          <div class="contaner-item__active"></div>
          <p class="contaner-item__text">77</p>
        </div>
        <RouterLink class="containerMain-items__buttom" v-on:click="submitElement" to="/gender/birthYear/excess/number/colorBlock">далее</RouterLink>
      </div>
    </div>
  </main>
</template>

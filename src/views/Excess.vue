...
export default {
  ...
  methods:{
    ...
    this.excess=e.target.innerText;
    ...
    submitElement(){
      store.dispatch('incrementPush',{excess: this.excess})
      router.beforeEach(()=>{
        if(this.excess === ""){
          return false;
        }
  ...
  <main class="about">
    <div class="containerMain">
      <div class="containerMain-items">
        ...
        <p class="text">Выберите лишнее:</p>
        <div class="contaner-item" v-on:click="activeElement" >
          <div class="contaner-item__active" ></div>
          <p class="contaner-item__text" >Дом</p>
        </div>
        <div class="contaner-item" v-on:click="activeElement" >
          <div class="contaner-item__active"></div>
          <p class="contaner-item__text">Шалаш</p>
        </div>
        <div class="contaner-item" v-on:click="activeElement" >
          <div class="contaner-item__active"></div>
          <p class="contaner-item__text">Бунгало</p>
        </div>
        <div class="contaner-item" v-on:click="activeElement" >
          <div class="contaner-item__active"></div>
          <p class="contaner-item__text">Скамейка</p>
        </div>
        <div class="contaner-item" v-on:click="activeElement" >
          <div class="contaner-item__active"></div>
          <p class="contaner-item__text">Хижина</p>
        </div>
        <RouterLink class="containerMain-items__buttom" v-on:click="submitElement" to="/gender/birthYear/excess/number">далее</RouterLink>
      </div>
    </div>
  </main>
</template>
